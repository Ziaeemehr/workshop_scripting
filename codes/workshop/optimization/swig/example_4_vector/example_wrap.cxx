...
SWIGINTERN PyObject *_wrap_my_class_half(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = reinterpret_cast< my_class * >(argp1);
  {
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "my_class_half" "', argument " "2"" of type '" "std::vector< double,std::allocator< double > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "my_class_half" "', argument " "2"" of type '" "std::vector< double,std::allocator< double > > const &""'"); 
    }
    arg2 = ptr;
  }
  result = (arg1)->half((std::vector< double,std::allocator< double > > const &)*arg2);
