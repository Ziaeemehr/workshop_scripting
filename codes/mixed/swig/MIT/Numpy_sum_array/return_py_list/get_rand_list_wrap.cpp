...
/*-----------------------------------------------
              @(target):= _get_rand_list.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__get_rand_list

#else
#  define SWIG_init    init_get_rand_list

#endif
#define SWIG_name    "_get_rand_list"
...
SWIGINTERN PyObject *_wrap_get_rand_list(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:get_rand_list",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "get_rand_list" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  result = get_rand_list(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"get_rand_list", _wrap_get_rand_list, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
